  ...
  return (
    <Card>
      ...
      <Card.Img
        ...
        src={
          data.image ||
          "https://media-exp1.licdn.com/dms/image/sync/D4D34AQFJTYjm-lVQNw/ugc-proxy-shrink_800/0/1660125678728?e=1661860800&v=beta&t=h-OxA5cXZeRlSihpjbeaZneOWseytLD7sTSgVF-9Lm8"
        }
      />
      <Card.Body>
        <div className='post-bottom-section'>
          <div className='d-flex flex-column post-bottom-title '>
            <div className='d-flex justify-content-between align-items-center mb-2'>
              <h6>Read a post</h6>
              <button className='post-bottom-section-button'>Learn more</button>
            </div>
            <p>linkedin.com</p>
          </div>
