...
const ModalUpdatePost = ({updatePost,handleClose,data}) => {
    ...
    const profile = useSelector(state => state.myProfile.profileData)
  ...
  return (
    ...
    <Modal.Header >
      ...
      <h5>Update Post</h5>
      <div className='d-flex align-items-center justify-content-center modal-header-dark-button-container' onClick={handleClose}>
        <svg 
    ...
    <Modal.Footer>
      <div className='d-flex align-items-center justify-content-between flex-grow-1'>
       ...
       <input type="file" name="file" id="file" className="inputfile" onChange={(e)=> setImgInput(e.target.files[0])}/>
      ...
      <Button className='modal-footer-anyone-button ml-2'>
       <FontAwesomeIcon icon={faCommentDots}/> Anyone
        ...
        <Button className='modal-footer-post-button'
         ...
         variant="primary" onClick={()=>{  handleClose(); dispatch(updatePostActionWithThunk(data._id,textInput,imgInput))  }}>
          Post
        </Button>
     </div>
    </Modal.Footer>
