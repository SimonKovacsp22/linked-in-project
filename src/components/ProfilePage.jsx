                    ...
                    <div className="my-profile-div">
                        <div className='profile-header-div'>
                            ...
                            <div className="my-profile-deatails d-flex justify-content-between p-3">
                                <div>
                                    <h4>{myProfile.name} {myProfile.surname}</h4>
                                    <p>{myProfile.title}</p>
                                    <p className='contact-info'>{myProfile.area}<Link to="/"> Contact info</Link></p>
                                    {/* <p>{myProfile.bio}</p> */}
                            ...
                            <div className="my-image-container">
                                <img className="my-profile-image" src={myProfile.image} alt="" />
                            </div>
